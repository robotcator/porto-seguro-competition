...
train_pred['target'] = GPAri(gptrain)
test_pred['target'] = GPAri(gptest)

full_score = gini(y, train_pred['target'])

write_csv(train_pred, test_pred, mdl_name='gp-orgi', mean=0.0, overall_mean=full_score, std=0, bag=-1)